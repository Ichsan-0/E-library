...
class TipeIsi extends CI_Controller {
    ...
    public function index()
    {
        ...
        if(!empty($cek) && $stts=='admin')
        {
            ...
            $tmp['tipes'] = $this->Master->get_tipes();
            
            $this->load->view('admin/master/tipe_isi',$tmp);
    ...
    public function addTipe() {
        ...
        $tipe_exists = $this->Master->isKodeTipeExists($kode_tipe);
        $nama_exists = $this->Master->isNamaTipeExists($nama_tipe);
        ...
        $insert_id = $this->Master->addTipe($data);
    ...
    public function editTipe($tipeId) {
        ...
        $tipeData = $this->Master->getTipeById($tipeId);
    ...
    // Check if nama_tipe already exists
            $nama_tipe_exists = $this->Master->isNamaTipeExists($nama_tipe);
            ...
            $isUpdateSuccessful = $this->Master->updateTipeData($tipeId, $data);
