...
class Home extends MY_Controller {
	...
	public function index(){
		...
		$data['jml_buku']=$this->Buku_model->jml_buku();
		$data['jml_kategori']=$this->Buku_model->jml_kategori();
    
    	$data['warna']=	array('#f56954','#00a65a','#f39c12','#00c0ef','#3c8dbc','#d2d6de', '#d9f442','#561d84','#f90ec3', '#31f7a4');
		//$tmp['content']=$this->load->view('admin/home2',$data, TRUE);
		
		//$this->load->view('admin/header',$tmp);
		//$this->load->view('admin/footer');
		$data['footer'] = $this->load->view('admin/footer','', TRUE);
        $tmp['header'] = $this->load->view('admin/header2',$data, TRUE);
		$this->load->view('admin/home2',$tmp);
	}
}
