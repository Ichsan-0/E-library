...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Sistem Ruang Baca Fasilkom UNSRI</title>
...
<body>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <h3 class="header center white-text text-lighten-2 z-depth-5">Ruang Baca Fasilkom UNSRI</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/back.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    By &copy; : <a href="#" target="_blank">www.Kampusimpian.com</a>
                </div>
