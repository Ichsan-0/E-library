...
<html lang="en" >
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: <?php echo base_url(); ?>assets/metronic/assets/app/media/img/bg/bg-2.jpg;">
				<div class="m-grid__item m-grid__item--fluid m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="<?php echo base_url(); ?>web/">
								<img src="<?php echo base_url(); ?>assets/metronic//assets/app/media/img/logos/sekolah.png">
							</a>
						</div>
						<div class="m-login__signin">
							<div class="m-login__head">
								<h3 class="m-login__title">
									Masuk kedalam Sistem Alazca Library
								</h3>
							</div>
							
							<form class="m-login__form m-form" action="<?php echo base_url('web/login'); ?>" method="POST">
		...
		<!--end::Base Scripts -->   
        <!--begin::Page Snippets -->
		<script src="<?php echo base_url(); ?>assets/metronic/assets/snippets/pages/user/login.js" type="text/javascript"></script>
		<!--end::Page Snippets -->
	</body>
	<!-- end::Body -->
</html>
