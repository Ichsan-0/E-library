	...
	<div 
		...
		>
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item m-menu__item--submenu <?php if ($this->uri->uri_string() == 'admin/Gmd') { echo "m-menu__item--expanded m-menu__item--open"; } ?>" aria-haspopup="true"  data-menu-submenu-toggle="hover">
								<a  href="#" class="m-menu__link m-menu__toggle">
								...
								<div class="m-menu__submenu" style="display : <?php if ($this->uri->uri_string() == 'admin/Gmd') { echo "block"; } else { echo "none"; }  ?>">
									<span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu <?php if ($this->uri->uri_string() == 'admin/Gmd') { echo "m-menu__item--expanded m-menu__item--open"; } ?>" aria-haspopup="true"  data-menu-submenu-toggle="hover">
											...
											<div class="m-menu__submenu" style="display : <?php if ($this->uri->uri_string() == 'admin/Gmd') { echo "block"; } else { echo "none"; }  ?>">
												<span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item <?php if ($this->uri->uri_string() == 'admin/Gmd') { echo " m-menu__item--active"; } ?> " aria-haspopup="true" >
														<a  href="<?php echo base_url(); ?>admin/Gmd" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">
