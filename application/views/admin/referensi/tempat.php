            						...
            						<?php foreach ($tempat as $t): ?>
                						<tr>
                    						...
                    						<td>
												...
												<a class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill btnDeleteGmd" title="Delete" data-id="<?php echo $t->id; ?>"  data-nama_tempat="<?php echo $t->nama_tempat; ?>">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editTipeForm" action="<?php echo base_url('admin/referensi/Tempat/updateTempat'); ?>" method="post">
				<div class="form-group">
                    <label for="nama_tempat" class="form-control-label">Nama Tempat</label>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="tempatId" name="tempatId">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="nama_tempat" class="form-control-label">Nama Tempat</label>
                    <input type="text" class="form-control" id="nama" name="nama_tempat">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    $(document).ready(function () {
        function handleDelete(id, nama_tempat) {
            if (confirm("Apakah Anda yakin ingin menghapus data Tempat [" + nama_tempat + "] ini?")) {
                $.post("<?php echo base_url('admin/referensi/Tempat/deleteTempat/'); ?>" + id, function (response) {
		...
		var nama_tempat = $("#nama").val();

            $.ajax({
                url: "<?php echo base_url('admin/referensi/Tempat/addTempat'); ?>",
                type: "POST",
                data: {
        ...
        function handleUpdate() {
            var tempatId  = $("#tempatId").val();
            var nama_tempat = $("#nama_tempat").val();

            $.ajax({
                url: 'Tempat/updateTempat',
                type: "post",
                data: {
                    id: tempatId,
                    nama_tempat : nama_tempat
