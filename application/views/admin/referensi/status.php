	...
	<?php echo $header; ?>
		...
		<!--begin: Datatable -->
								<table class="m-datatable" id="html_table" width="100%">
    								...
    								<tbody>
									<?php $count = 1; ?>
            						<?php foreach ($status as $med): ?>
                						<tr>
                    						<td><?php echo $count; ?></td>
                    						<td><?php echo $med->kode_status; ?></td>
											<td><?php echo $med->nama_status; ?></td>
											<td><?php echo $med->aturan; ?></td>
                    						...
                    						<td>
												...
												<a class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill btnDeleteMedia" title="Delete" data-id="<?php echo $med->id; ?>" data-nama_status="<?php echo $med->nama_status; ?>">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Status Eksemplar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="editMediaForm" action="<?php echo base_url('admin/referensi/Status/updateStatus'); ?>" method="post">
					<div class="form-group">
						<label class="form-control-label">Kode Status Eksemplar</label>
						<input type="text" class="form-control" id="kode_status" name="kode_status">
					</div>
					<div class="form-group">
						<label class="form-control-label">Nama Status Eksemplar</label>
						<input class="form-control" id="nama_status" name="nama_status"></input>
					</div>
					<div class="form-group">
						<label class="form-control-label">Aturan</label>
						<select class="form-control m-input" id="aturan" name="aturan">
							<option value="1">Tidak Ada Transaksi Peminjaman</option>
							<option value="2">Lewatkan ketika Inventarisasi</option>
						</select>
					</div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btnUpdateStatus">Update data</button>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Status Eksemplar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
				<div class="form-group">
                    <label class="form-control-label">Kode Status Eksemplar</label>
                    <input type="text" class="form-control" id="kode" name="kode_status">
                </div>
				<div class="form-group">
                    <label class="form-control-label">Nama Status Eksemplar</label>
                    <input class="form-control" id="nama" name="nama_status"></input>
                </div>
				<div class="form-group">
                    <label class="form-control-label">Aturan</label>
                    <select class="form-control m-input" id="atur" name="aturan">
						<option value="1">Tidak Ada Transaksi Peminjaman</option>
						<option value="2">Lewatkan ketika Inventarisasi</option>
					</select>
                </div>
...
<script>
    $(document).ready(function () {
        function handleDelete(id, nama_status) {
            if (confirm("Apakah Anda yakin ingin menghapus status eksemplar [" + nama_status + "] ini?")) {
                $.post("<?php echo base_url('admin/referensi/Status/deleteStatus/'); ?>" + id, function (response) {
		...
		var kode_status = $("#kode").val();
		var nama_status = $("#nama").val();
		var aturan = $("#atur").val();

            $.ajax({
                url: "<?php echo base_url('admin/referensi/Status/addStatus'); ?>",
                type: "POST",
                data: {
        ...
        $(document).on('click', '.btnDeleteMedia', function () {
            var id = $(this).data("id");
			var nama_status = $(this).data("nama_status");
            handleDelete(id, nama_status);
        });
        ...
        $(document).on('click', '.btnEditMedia', function () {
            ...
            $.ajax({
                url: 'Status/editStatus/' + statusId,
                type: 'GET',
                dataType: 'json',
