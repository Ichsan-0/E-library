...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>assets2/img/logo.png" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Alazca</b>Library</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logo_warna.png" alt="" srcset="" width="47px">
        </a>
      </center>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/Nim"><i class="fa fa-building-o"></i>Data Nim Mahasiswa</a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="#">SI Ruang Baca Fasilkom UNSRI</a>.</strong> 
  </footer>
