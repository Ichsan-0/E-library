    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit data Tipe Isi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="editTipeForm" action="<?php echo base_url('admin/master/TipeIsi/updateTipe'); ?>" method="post">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Tipe Isi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    $(document).ready(function () {
        function handleDelete(id) {
            if (confirm("Apakah Anda yakin ingin menghapus data Tipe Isi ini?")) {
                $.post("<?php echo base_url('admin/master/TipeIsi/deleteTipe/'); ?>" + id, function (response) {
		...
		var nama_tipe = $("#nama").val();
            ...
            $.ajax({
                url: "<?php echo base_url('admin/master/TipeIsi/addTipe'); ?>",
                type: "POST",
                data: {
                    kode_tipe: kode_tipe,
                    nama_tipe: nama_tipe,
